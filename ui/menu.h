...
typedef struct {
	const char  name[11];    // menu display area only has room for 6 characters
	uint8_t     menu_id;
} t_menu_item;
...
extern const char		gSubMenu_W_N[3][6];
extern const char		gSubMenu_TOT[11][8];
...
#endif
extern const char		gSubMenu_PTT_ID[5][10];
...
extern bool 			settingsSubMenuActive;
