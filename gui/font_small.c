...
const uint8_t font_smallBitmaps[] PROGMEM = {
  ...
  0x00, 0xE0, 0xBF, 0xE5, 0x6F, 0xFF, 0xF0, 0xE0, 0xF7, 0xDA, 0xF7, 0x5E, 
  0xF2, 0x4E, 0xD6, 0xDC, 0xF3, 0xCE, 0xF3, 0x48, 0xF2, 0xDE, 0xB7, 0xDA, 
  0xF8, 0x24, 0x9E, 0xB7, 0x5A, 0x92, 0x4E, 0xDD, 0x6B, 0x58, 0x80, 0xF6, 
  0xDA, 0xF6, 0xDE, 0xF7, 0xC8, 0xF7, 0x92, 0xF7, 0x5A, 0xF3, 0x9E, 0xE9, 
  0x24, 0xB6, 0xDE, 0xB6, 0xD4, 0x8C, 0x6B, 0x5D, 0x80, 0xB5, 0x5A, 0xB7, 
  0x9E, 0xE5, 0x4E, 0xFE
};
...
const GFXglyph font_smallGlyphs[] PROGMEM = {
  ...
  {   133,   8,   3,   9,    0,   -3 },   // 0x5D ']'
  {   136,   4,   5,   5,    0,   -4 },   // 0x5E '^'
  {   139,   3,   1,   4,    0,    0 },   // 0x5F '_'
  {     0,   0,   0,   0,    0,    0 },   // 0x60 '`'
  {   140,   3,   5,   4,    0,   -4 },   // 0x61 'a'
  {   142,   3,   5,   4,    0,   -4 },   // 0x62 'b'
  {   144,   3,   5,   4,    0,   -4 },   // 0x63 'c'
  {   146,   3,   5,   4,    0,   -4 },   // 0x64 'd'
  {   148,   3,   5,   4,    0,   -4 },   // 0x65 'e'
  {   150,   3,   5,   4,    0,   -4 },   // 0x66 'f'
  {   152,   3,   5,   4,    0,   -4 },   // 0x67 'g'
  {   154,   3,   5,   4,    0,   -4 },   // 0x68 'h'
  {   156,   1,   5,   2,    0,   -4 },   // 0x69 'i'
  {   157,   3,   5,   4,    0,   -4 },   // 0x6A 'j'
  {   159,   3,   5,   4,    0,   -4 },   // 0x6B 'k'
  {   161,   3,   5,   4,    0,   -4 },   // 0x6C 'l'
  {   163,   5,   5,   6,    0,   -4 },   // 0x6D 'm'
  {   167,   3,   5,   4,    0,   -4 },   // 0x6E 'n'
  {   169,   3,   5,   4,    0,   -4 },   // 0x6F 'o'
  {   171,   3,   5,   4,    0,   -4 },   // 0x70 'p'
  {   173,   3,   5,   4,    0,   -4 },   // 0x71 'q'
  {   175,   3,   5,   4,    0,   -4 },   // 0x72 'r'
  {   177,   3,   5,   4,    0,   -4 },   // 0x73 's'
  {   179,   3,   5,   4,    0,   -4 },   // 0x74 't'
  {   181,   3,   5,   4,    0,   -4 },   // 0x75 'u'
  {   183,   3,   5,   4,    0,   -4 },   // 0x76 'v'
  {   185,   5,   5,   6,    0,   -4 },   // 0x77 'w'
  {   189,   3,   5,   4,    0,   -4 },   // 0x78 'x'
  {   191,   3,   5,   4,    0,   -4 },   // 0x79 'y'
  {   193,   3,   5,   4,    0,   -4 },   // 0x7A 'z'
  {     0,   0,   0,   0,    0,    0 },   // 0x7B '{'
  {   195,   1,   7,   2,    0,   -5 }    // 0x7C '|'
};
